...
const MEAL_NUDGE_TEXT = {
    breakfast: 'おはようございます☀️ 朝ごはんの記録がまだみたいです！もう食べましたか？\n食べていたら写真か「◯◯食べた」で送ってくださいね📷\nこれからなら、今の体調と気分、食べたいものを教えてください！あなたに合う朝メニューを考えますから🍽✨',
    lunch: 'お昼ですよ🍱 昼食の記録がまだみたいです！もう食べましたか？\n食べていたら写真か「◯◯食べた」で送ってくださいね📷\nこれからなら、今の体調と気分、食べたいものを教えてください！午後も動けるメニューを考えますね✨',
    dinner: '夜ごはんの記録がまだみたいです🌙 もう食べましたか？\n食べていたら写真か「◯◯食べた」で送ってくださいね📷\nこれからなら、今の体調と気分、食べたいものを教えてください！目標と満足感のバランスを取りますから🍽✨',
};
